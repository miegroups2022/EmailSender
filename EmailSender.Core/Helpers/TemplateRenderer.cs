...
namespace EmailSender.Core.Helpers
{
    ...
    public class TemplateRenderer
    {
        ...
        public string RenderSubject(EmailRecipient addr)
            => Render(_subject, BuildVars(addr));

        public string RenderHtmlBody(EmailRecipient addr)
            => Render(_htmlBody, BuildVars(addr));

        public string RenderTextBody(EmailRecipient addr)
            => Render(_textBody, BuildVars(addr));

        public string Render(string template, EmailRecipient addr)
        ...
        private Dictionary<string, string> BuildVars(EmailRecipient addr)
        {
